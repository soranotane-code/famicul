...
def create_hospital(
    ...
    return hospital_service.create_hospital_service(db, hospital_in)
...
def get_hospitals(
    ...
    # serviceに処理を委譲して結果だけを返す
    return hospital_service.get_hospitals_service(db)
...
def get_hospital(
    ...
    # serviceに処理を委譲して結果だけを返す
    return hospital_service.get_hospital_service(db, id)
...
def update_hospital(
    ...
    # serviceに処理を委譲して結果だけを返す
    return hospital_service.update_hospital_service(db, id, hospital_in)
...
def delete_hospital(
    ...
    # serviceに処理を委譲して結果だけを返す
    return hospital_service.delete_hospital_service(db, id)